...
class MyTheme with ChangeNotifier {
  ...
  String appFont = Hive.box('settings').get(
    'appFont',
    defaultValue: 'Oswald',
  );
  ...
  void refresh() {
    ...
    accentColor =
        settingsBox.get('themeColor', defaultValue: 'Indigo') as String;

    appFont = settingsBox.get(
      'appFont',
      defaultValue: 'Oswald',
    ) as String;
  ...
  void switchFont(String font, {bool notify = true}) {
    Hive.box('settings').put('appFont', font);
    appFont = font;
